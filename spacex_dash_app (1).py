...
# Leemos los datos de la aerolínea en un dataframe de pandas
...
# Creamos un diseño de aplicación
...
def update_graph(site_dropdown, payload_slider):
    if site_dropdown == 'ALL':
        ...
        scatterplot = px.scatter(filtered_data, x="Payload Mass (kg)", y="class", 
        color="Booster Version Category", title=f'Correlation between Payload and Success for {site_dropdown}')
        return scatterplot
